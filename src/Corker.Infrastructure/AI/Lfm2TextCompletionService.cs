...
public class Lfm2TextCompletionService : ILLMService, ILLMStatusProvider, IDisposable
{
    ...
    public async Task InitializeAsync()
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Settings loaded. Backend: {Backend}", settings.AIBackend);
            ...
            {
                 _logger.LogWarning(ex, "Failed to read model file info.");
            }
    ...
    public async Task<string> GenerateTextAsync(string prompt, CancellationToken cancellationToken = default)
    {
        ...
        var inferenceParams = new InferenceParams() { MaxTokens = 2048, AntiPrompts = new List<string> { "User:", "Assistant:" } };
